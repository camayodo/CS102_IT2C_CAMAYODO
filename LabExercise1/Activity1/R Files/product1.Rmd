...
```
```{r}
url <- "https://www.amazon.co.uk/s?k=shampoo&crid=1N5C7RD5GUCTZ&sprefix=shampooo%2Caps%2C345&ref=nb_sb_noss_2"
```
```{r}
...
```
```{r}
product_df <- data.frame(Brand_Description = brand_descriptions,
                         Price = prices,
                         Review_Count = review_counts,
                         Rating = ratings)
```
```{r}
write.csv(product_df, "ProductData.csv", row.names = FALSE)
```

product_df1$Category <- "Shampoo"
